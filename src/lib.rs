// src/lib.rs
/*
 * Core library for OpenhabBinding
 */
...
#[derive(Debug)]
pub struct OpenhabBindingProcessor {
    verbose: bool,
    processed_count: usize,
}

impl OpenhabBindingProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting OpenhabBinding processing");
    
    let mut processor = OpenhabBindingProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = OpenhabBindingProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = OpenhabBindingProcessor::new(false);
